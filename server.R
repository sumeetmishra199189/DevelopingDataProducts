source("~/Desktop/R_Programing/bmi.r")
...
shinyServer(function(input, output) {
  ...
  output$result <- renderText({
    ...
    if      (bmi <  15.0) info = "<span style='color: pink'>Very severely underweight</span>"
    ...
    else if (bmi <= 30.0) info = "<span style='color: violet'>Overweight</span>"
    else if (bmi <= 35.0) info = "<span style='color: yellow'>Obese Class I (Moderately obese)</span>"
    else if (bmi <= 40.0) info = "<span style='color: blue'>Obese Class II (Severely obese)</span>"
    else                  info = "<span style='color: cyan'>Obese Class III (Very severely obese)</span>"
